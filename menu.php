        	...
        	<div class="col-lg-7 col-sm-8 featured-work">
            	<div class="featured-box">
                    <div class="featured-box-col2 wow fadeInRight delay-02s">
                        <br>
                        <p class="justify">
                            <b>Qualidade</b> - Buscamos sempre excelência ao servir nossos clientes, foco em servir bem para servir sempre.<br><br>
                ...
                <div class="featured-box">
                    <div class="featured-box-col2 wow fadeInRight delay-02s">
                        <p class="justify"><br>
                            ...
                            viabilizando a sustentabilidade do segmento de panificação e confeitaria.<br> <br>
                            ...
                            panificação e confeitaria.<br><br>
...
<section class="main-section" id="Cadastro" style="background: url('img/fundo_login.jpg')no-repeat;">
	<div class="container">
        <div class="row">
            <div class="col-lg-12 col-sm-12 wow fadeInLeft delay-05s" style="background:rgba(251, 251, 251, 0.8);">
                <div class="service-list">
                    <div class="container" stye="float:center;">
                        <h2>Área Restrita</h2>
                        <h6>Preencha o formulário abaixo para se cadastrar.</h6> 
