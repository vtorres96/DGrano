                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {	?>
                                    <tr>
                                        ...
                                        <td><button type="button" class="btn btn-xs btn-warning" data-toggle="modal" data-target="#exampleModal" data-whatever="<?php echo $row['id']; ?>" data-whatevernome="<?php echo $row['nome']; ?>"  data-whateveremail="<?php echo $row['email']; ?>" data-whateverusuario="<?php echo $row['usuario']; ?>" data-whateversenha="<?php echo $row['senha']; ?>">Alterar Cadastro</button></td>
                                    </tr>
                                <?php } ?>
...
<script type="text/javascript">
        $('#exampleModal').on('show.bs.modal', function (event) {
                ...
                var modal = $(this)
                modal.find('.modal-title').text('Alteração de Cadastro do Usuário: ' + recipientnome)
